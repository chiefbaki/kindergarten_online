...
import 'package:kindergarten_online/src/features/chats/data/mappers/chat_list_mapper.dart';
import 'package:kindergarten_online/src/features/chats/data/mappers/chat_messages_list_mapper.dart';
import 'package:kindergarten_online/src/features/chats/data/mappers/contact_mapper.dart';
import 'package:kindergarten_online/src/features/chats/data/mappers/create_group_mapper.dart';
...
class ChatImpl implements ChatRepository {
  ...
  Future<DataState<ContactEntity>> getContact({String? query}) async {
    ...
    try {
      final httpResponse = await _remoteChatData.getContact(query: query);
